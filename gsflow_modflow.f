...
C     ------------------------------------------------------------------
     ...
     &    Have_lakes, MODFLOW, MODSIM_MODFLOW, Diversion2soil_flag
...
!     ------------------------------------------------------------------
      USE GSFMODFLOW
      USE PRMS_MODULE, ONLY: Kper_mfo, Print_debug, Kkiter, Model,
...
C
      ...
      USE GSFMODFLOW
      USE PRMS_MODULE, ONLY: Print_debug, Logunt, Timestep, Kkiter
...
!***********************************************************************
     ...
     &    Print_debug, MODFLOW, MODSIM_MODFLOW

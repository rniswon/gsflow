...
! Functions
      INTRINSIC :: DATE_AND_TIME, INT, TRIM
      ...
      EXTERNAL :: module_doc, nsub_summary
...
!***********************************************************************
  ...
  16  FORMAT (//, 78('-'), /, 'Active modules listed in the order in which they are called:', //, 8X, 'Process', 16X, &
